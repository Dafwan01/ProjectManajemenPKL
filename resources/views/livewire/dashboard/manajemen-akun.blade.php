<div>
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Kelola data akun pengguna, pendaftaran pengguna baru, serta hak akses peran (role) sistem.</p>
    </div>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-800/60">
                    @forelse($users as $user)
                        ...
                        <tr class="bg-white dark:bg-gray-900 hover:bg-gray-50/80 dark:hover:bg-gray-800/40 transition">
                            ...
                            <!-- Penulisan Tanggal Baku Indonesia (Contoh: "07 Agustus 2026") -->
