                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <button 
                                        ...
                                        class="flex items-center gap-2 px-4 py-2 text-xs font-semibold text-white bg-blue-600 hover:bg-blue-500 rounded-2xl shadow-md shadow-blue-600/20 disabled:opacity-50 transition shrink-0"
                                    >
                                    ...
                                    @error("files.{$user->user_id}")
                                        <span class="text-rose-600 dark:text-rose-400 text-xs mt-1.5 font-medium text-center">{{ $message }}</span>
                                    @enderror
                                </div>
                            </td>
                        </tr>
