<div>
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white uppercase">Unggah Surat Penerimaan Magang</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Kelola dan unggah berkas surat penerimaan magang peserta.</p>
    </div>

    <!-- Flash Message Notifikasi -->
    @if (session()->has('message'))
        <div class="p-4 mb-6 text-sm text-emerald-700 dark:text-emerald-400 rounded-2xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 flex items-center justify-between shadow-sm" role="alert">
            ...
            <table class="w-full text-sm text-left text-gray-700 dark:text-gray-300">
                <thead class="text-xs uppercase bg-gray-50 dark:bg-gray-900/60 text-gray-600 dark:text-gray-400 border-b border-gray-200 dark:border-gray-700/80">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4">Status Berkas</th>
                        <th scope="col" class="px-6 py-4 text-center">Tanggal Unggah</th>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700/60">
                    @forelse($users as $user)
                        ...
                        <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/40 transition">
                            ...
                            <!-- Tanggal Unggah Berkas (Format Bahasa Indonesia: Contoh "07 Agustus 2026") -->
