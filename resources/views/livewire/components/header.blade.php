<div class="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 transition-colors duration-200" 
     x-data="{ 
        ...
        init() {
            // Jalankan sinkronisasi class dark ke <html> saat halaman/komponen dimuat
            if (this.darkMode) {
     ...
     <div class="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-slate-900 flex flex-col justify-between">
        <div>
           ...
           <ul class="space-y-1.5 font-medium">
              <!-- 1. Dashboard -->
              <li>
                 <a href="{{ route('dashboard') }}" wire:navigate class="flex items-center p-2.5 rounded-xl transition-all {{ request()->routeIs('dashboard') ? 'bg-blue-600 text-white font-semibold shadow-md shadow-blue-600/20' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/80 hover:text-slate-900 dark:hover:text-white' }} group">
                    <svg class="w-5 h-5 transition duration-75 {{ request()->routeIs('dashboard') ? 'text-white' : 'text-slate-500 dark:text-slate-400 group-hover:text-slate-900 dark:group-hover:text-white' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
              ...
              <!-- 2. Melihat Absensi -->
              <li>
                 <a href="{{ route('monitoring-absensi') }}" wire:navigate class="flex items-center p-2.5 rounded-xl transition-all {{ request()->routeIs('monitoring-absensi') ? 'bg-blue-600 text-white font-semibold shadow-md shadow-blue-600/20' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/80 hover:text-slate-900 dark:hover:text-white' }} group">
                    <svg class="w-5 h-5 transition duration-75 {{ request()->routeIs('monitoring-absensi') ? 'text-white' : 'text-slate-500 dark:text-slate-400 group-hover:text-slate-900 dark:group-hover:text-white' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
              ...
              <li>
                 <a href="{{ route('manajemen-pkl') }}" wire:navigate class="flex items-center p-2.5 rounded-xl transition-all {{ request()->routeIs('manajemen-pkl') ? 'bg-blue-600 text-white font-semibold shadow-md shadow-blue-600/20' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/80 hover:text-slate-900 dark:hover:text-white' }} group">
                    <svg class="w-5 h-5 transition duration-75 {{ request()->routeIs('manajemen-pkl') ? 'text-white' : 'text-slate-500 dark:text-slate-400 group-hover:text-slate-900 dark:group-hover:text-white' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
              ...
              <li x-data="{ open: {{ request()->routeIs('sertifikat', 'nilai', 'surat-penerimaan-magang') ? 'true' : 'false' }} }">
                 ...
                 >
                     <svg class="w-5 h-5 text-slate-500 dark:text-slate-400 transition duration-75 group-hover:text-slate-900 dark:group-hover:text-white {{ request()->routeIs('sertifikat', 'nilai', 'surat-penerimaan-magang') ? 'text-slate-900 dark:text-white' : '' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                 ...
                 <ul x-show="open" x-cloak class="py-2 space-y-1">
                     <li>
                         <a href="{{ route('sertifikat') }}" wire:navigate class="flex items-center w-full p-2 text-sm transition duration-75 rounded-lg pl-11 group {{ request()->routeIs('sertifikat') ? 'bg-blue-600 text-white font-semibold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/80 hover:text-slate-900 dark:hover:text-white' }}">Sertifikat</a>
                     </li>
                     <li>
                         <a href="{{ route('nilai') }}" wire:navigate class="flex items-center w-full p-2 text-sm transition duration-75 rounded-lg pl-11 group {{ request()->routeIs('nilai') ? 'bg-blue-600 text-white font-semibold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/80 hover:text-slate-900 dark:hover:text-white' }}">Nilai</a>
                     </li>
                     <li>
                         <a href="{{ route('surat-penerimaan-magang') }}" wire:navigate class="flex items-center w-full p-2 text-sm transition duration-75 rounded-lg pl-11 group {{ request()->routeIs('surat-penerimaan-magang') ? 'bg-blue-600 text-white font-semibold' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/80 hover:text-slate-900 dark:hover:text-white' }}">Surat Penerimaan Magang</a>
                     </li>
                 </ul>
              </li>
              ...
              <!-- 5. Manajemen Akun -->
              <li>
                 <a href="{{ route('manajemen-akun') }}" wire:navigate class="flex items-center p-2.5 rounded-xl transition-all {{ request()->routeIs('manajemen-akun') ? 'bg-blue-600 text-white font-semibold shadow-md shadow-blue-600/20' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/80 hover:text-slate-900 dark:hover:text-white' }} group">
                    <svg class="w-5 h-5 transition duration-75 {{ request()->routeIs('manajemen-akun') ? 'text-white' : 'text-slate-500 dark:text-slate-400 group-hover:text-slate-900 dark:group-hover:text-white' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
              ...
              <!-- 6. Rekap Absensi -->
              <li>
                 <a href="{{ route('rekap-absensi') }}" wire:navigate class="flex items-center p-2.5 rounded-xl transition-all {{ request()->routeIs('rekap-absensi') ? 'bg-blue-600 text-white font-semibold shadow-md shadow-blue-600/20' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800/80 hover:text-slate-900 dark:hover:text-white' }} group">
                    <svg class="w-5 h-5 transition duration-75 {{ request()->routeIs('rekap-absensi') ? 'text-white' : 'text-slate-500 dark:text-slate-400 group-hover:text-slate-900 dark:group-hover:text-white' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                       <path d="M10 10a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z"/>
                    </svg>
        ...
        <div class="pt-4 border-t border-slate-200 dark:border-slate-800/80">
           <form method="POST" action="{{ route('logout') }}">
               ...
               <button type="submit" class="w-full flex items-center p-2.5 text-rose-600 dark:text-rose-400 rounded-xl hover:bg-rose-50 dark:hover:bg-rose-950/30 group transition">
                   <svg class="w-5 h-5 text-rose-600 dark:text-rose-400 transition duration-75 group-hover:translate-x-0.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
  ...
  <!-- AREA KONTEN UTAMA -->
  <div class="sm:ml-64 bg-slate-50 dark:bg-slate-950 min-h-screen transition-colors duration-200">
     ...
     <header class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md flex justify-between items-center w-full h-16 px-6 border-b border-slate-200 dark:border-slate-800/80 sticky top-0 z-30 transition-colors duration-200">
         ...
         <div>
             ...
             <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="inline-flex items-center p-2 text-sm text-slate-500 dark:text-slate-400 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-200 dark:focus:ring-slate-700 sm:hidden">
         ...
         <div class="flex items-center gap-3">
             ...
             <button @click="toggleTheme()" type="button" class="p-2 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 transition" title="Ubah Mode Tampilan">
                 ...
                 <!-- Icon Bulan (Tampil saat Light Mode aktif) -->
     ...
     <main class="p-6 bg-slate-50 dark:bg-slate-950 min-h-[calc(100vh-4rem)]">
         {{ $slot }}
     </main>
...
<!-- SCRIPT RE-INITIALIZE FLOWBITE SETELAH NAVIGATION LIVEWIRE -->
<script>
