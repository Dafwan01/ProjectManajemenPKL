<div>
    <div class="w-full mx-auto max-w-4xl">
        ...
        <div class="mb-6 border-b border-gray-200 dark:border-gray-800 pb-4">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white tracking-wide uppercase">Jadwal Magang</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Lihat jadwal kerja mingguan Anda selama masa magang (Senin - Jumat).</p>
        </div>
        ...
        <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800/50 text-blue-700 dark:text-blue-300 text-sm rounded-2xl flex items-center gap-3 shadow-sm">
            ...
            <span>Hari ini adalah <strong>{{ $namaHariIni }}</strong>. Jadwal hari ini ditandai dengan warna biru pada tabel di bawah.</span>
        </div>
                ...
                <table class="w-full text-sm text-left text-gray-600 dark:text-gray-300">
                    <thead class="text-xs uppercase bg-gray-50 dark:bg-gray-800/50 text-gray-500 dark:text-gray-400 border-b border-gray-200 dark:border-gray-800">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4 font-bold text-center">Jam Keluar</th>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-6 py-10 text-center text-gray-400 dark:text-gray-500">
                                    Belum ada jadwal yang ditetapkan untuk Anda. Silakan hubungi Mentor/Admin.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
        ...
        <div class="mt-4 flex flex-wrap items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
            <div class="flex items-center gap-1.5">
                ...
                <span>WFO: Wajib hadir di kantor sesuai radius yang ditentukan.</span>
            </div>
            <div class="flex items-center gap-1.5">
                <span class="w-2.5 h-2.5 rounded-full bg-blue-500"></span>
                <span>WFH: Bebas presensi dari lokasi mana saja.</span>
            </div>
        </div>
