<div class="max-w-4xl mx-auto py-6 px-4">
    ...
    @if (session()->has('warning'))
        <div class="mb-6 p-4 bg-yellow-100 dark:bg-yellow-900/80 border border-yellow-400 dark:border-yellow-500 text-yellow-800 dark:text-yellow-200 rounded-xl flex items-center justify-between shadow-lg">
            ...
            <button type="button" class="text-yellow-600 dark:text-yellow-300 hover:text-gray-900 dark:hover:text-white" onclick="this.parentElement.remove()">✕</button>
        </div>
    @endif
        ...
        <form wire:submit.prevent="simpanProject" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" wire:model.defer="nama_project" placeholder="Contoh: Sistem Informasi Presensi berbasis Laravel" 
                    class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white rounded-lg px-4 py-2.5 focus:border-purple-500 focus:outline-none text-sm">
                ...
                @if ($existing_file)
                    <div class="mt-3 p-3 bg-gray-50 dark:bg-gray-900/80 rounded-lg border border-gray-200 dark:border-gray-700 flex items-center justify-between">
                        <div class="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-300">
                            <svg class="w-4 h-4 text-green-500 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
